...
class TestParser {
    ...
    private function genericCellsRecognized() {
        ...
        $items[] = array(127, new Meeting('21.2,7.3,21.3,4.4,18.4,2.5,16.5,30.5,13.6,', '5', 'В-206', 'Экономика недвижимости', 'лек.', 'Иевлева', 'ВЭМ-413'));
        $items[] = array(149, new Meeting('22.2,8.3,22.3,5.4,19.4,3.5,17.5,31.5,14.6,', '2', 'В-111', 'Деловой ин.яз.', 'пр.', 'Хван', 'ВЭМ-5'));
        $items[] = array(74, new Meeting('14.2,28.2,14.3,28.3,11.4,25.4,9.5,23.5,6.6,', '2', 'В-209', 'Теор.планир.эксп.', 'лаб.', 'Короткова', 'ВВТ-406', '1п/г 2п/г'));
        $items[] = array(69, new Meeting('13.2,27.2,13.3,27.3,10.4,24.4,8.5,22.5,5.6,', '1', 'Б-104', 'БЖД', 'лек.', 'Александрина', 'ВВТ-406'));
        $items[] = array(61, new Meeting('11.2,25.2,11.3,25.3,8.4,22.4,6.5,20.5,3.6,', '1', 'В-206', 'Вып.выпуск.раб.', 'лек.', 'Рыбанов', 'ВВТ-406'));
    ...
    private function doubleLineTitleRecognized() {
        ...
        $items[] = array(163, new Meeting('18.2,4.3,18.3,1.4,15.4,13.5,27.5,10.6,', '2', 'А-29', 'Комп.мет.и инф.сист.в техн.синт. пер.полим.', 'лаб.', 'Александрина', 'ВТПЭ-5'));
        if ( !$this->findMatch($title, $items) ) return false;
        $this->report($title, true);
        return true;
    }
    ...
    private function complexDisciplinesRecognized() {
        ...
        $items[] = array(104, new Meeting('13.2,27.2,13.3,27.3,10.4,24.4,8.5,22.5,5.6,', '4', 'Б-207', 'Химия', 'лаб.', 'Перевалова', 'ВЭ-411', '1 п/г'));
        $items[] = array(102, new Meeting('13.2,27.2,13.3,27.3,10.4,24.4,8.5,22.5,5.6,', '3', 'А-16', 'Комп.графика', 'лаб.', 'Саразов А.В.', 'ВЭ-411'));
